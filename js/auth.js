...
const I18N = {
  id: { 
    ...
    voyages_difficulty: 'Rating', voyages_osn_level: 'Level OSN', voyages_reward: 'Ganjaran',
    ...
    admin_assignee_label: 'Penerima (Assignee)', admin_assignee_placeholder: 'Nama anggota…',
    ...
    admin_action_type_label: 'Jenis Tindakan', admin_action_download: 'Unduh PDF', admin_action_link: 'Buka Tautan',
    admin_url_label: 'Tautan / URL File',
    ...
    admin_difficulty_label: 'Tingkat Kesulitan',
  ...
  en: {
    ...
    admin_assignee_label: 'Assignee', admin_assignee_placeholder: 'Member name…',
    ...
    admin_action_type_label: 'Action Type', admin_action_download: 'Download PDF', admin_action_link: 'Open Link',
    admin_url_label: 'Link / File URL',
    ...
    admin_difficulty_label: 'Difficulty Level',
